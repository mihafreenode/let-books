...
sources:
  - ../../sources/bs/when-the-demo-is-evidence-and-when-it-is-not.md
status: draft
---
...
- treba li ga javna dokumentacija opisati kao ciljni sistem
...
Demo je i dalje važan. Samo je važan unutar dokumentovanog sistema, umjesto da ga zamijeni.
