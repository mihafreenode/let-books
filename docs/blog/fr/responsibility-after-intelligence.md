...
title: Responsabilité après l'intelligence
summary: À mesure que l'IA devient plus capable, les questions les plus profondes portent de moins en moins sur la seule capacité technique et de plus en plus sur le jugement humain, la responsabilité, la gouvernance et la dignité.
topics:
...
sources:
  - ../../sources/fr/responsibility-after-intelligence.md
status: draft
---
...
À quelle vitesse s'améliore-t-il ?
Quelles tâches peut-il automatiser ?
Quels outils peut-il appeler ?
Dans quelle mesure peut-il imiter le raisonnement ?
...
Traduire.
Organiser.
Faire remonter des incohérences.
Générer des alternatives.
Accélérer le travail routinier.
...
Une recommandation sous forme de brouillon peut devenir une décision par défaut si personne ne veut la rouvrir.
Un score de modèle peut devenir une politique si les gens cessent de demander comment il devrait être utilisé.
Un résumé généré peut remplacer la lecture directe si la vitesse devient la seule valeur.
Une relation simulée peut déplacer une relation réelle si la commodité devient la mesure de l'adéquation.
...
Les questions entrent.
Les réponses sortent.
Le raisonnement interne n'est visible qu'en partie.
La réponse peut être impressionnante.
La réponse peut aussi être fausse, superficielle, aveugle au contexte ou mal alignée avec la responsabilité réelle en jeu.

Ce modèle m'aide parce qu'il décourage à la fois l'emballement et la sentimentalité.

Un oracle peut être utile.
Un oracle peut même être remarquablement utile.
Mais un oracle n'est pas responsable.

Cela signifie que la confiance doit être structurée autour de limites.

Qui est autorisé à demander quoi ?
Qui est autorisé à agir sur la base de la réponse ?
Qu'est-ce qui doit être validé ?
Qu'est-ce qui doit être revu ?
Qu'est-ce qui exige une approbation explicite ?
Qu'est-ce qui est journalisé ?
Qu'est-ce qui reste une décision humaine quelle que soit la force de persuasion de la sortie ?
...
Les traditions religieuses parlent souvent de dignité humaine.
Les disciplines d'ingénierie parlent souvent de responsabilité humaine.

Le vocabulaire diffère.
La préoccupation est souvent étonnamment semblable.
...
Une personne ne devrait pas être traitée comme si elle n'était qu'une entrée dans un système.
Et un système ne devrait pas être traité comme s'il pouvait porter à lui seul la responsabilité humaine.
...
Qui définit l'usage acceptable ?
Qui peut auditer les décisions ?
Qui peut contester une sortie ?
Qui supporte le coût de l'erreur ?
Qui bénéficie de l'échelle ?
Qui devient dépendant de systèmes qu'il ne comprend pas et sur lesquels il ne peut exercer aucune influence significative ?
...
Une bonne gouvernance n'est pas le refus d'utiliser des systèmes puissants.
C'est le refus de les utiliser de manière irresponsable.
...
Ce ne sont pas des signes d'échec de l'IA.
Ce sont des signes que les humains comprennent encore leur rôle.
...
Cette question concerne les ingénieurs.
Les enseignants.
Les éditeurs.
Les chercheurs.
Les journalistes.
...
Cela ne supprime pas le besoin de jugement.
Cela augmente le coût du fait de le négliger.
...
Non parce que les humains sont sans défaut.
Non parce que les machines sont mauvaises.
Mais parce que la responsabilité reste un fardeau humain, et que la dignité humaine dépend encore de la volonté des personnes et des institutions de le porter.
