...
Dans le chemin supérieur, le dépôt conserve le code et les tests avec au moins une ébauche révisable de l'intention, des hypothèses et de la justification. Dans le chemin inférieur, le code et les tests survivent, mais une grande partie de la compréhension qui les entoure disparaît.
...
Le bug était ponctuel. La compréhension de son importance, elle, est devenue plus durable.
