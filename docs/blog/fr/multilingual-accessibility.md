...
summary: Pourquoi l'accessibilité et la localisation devraient être conçues ensemble à travers les métadonnées de langue, les lecteurs d'écran, le langage simple, les légendes et l'alt text.
topics:
  - accessibility
  - localization
  - multilingual-ux
