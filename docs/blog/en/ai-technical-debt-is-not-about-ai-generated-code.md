...
In the left path, the repository accumulates behavior and loses context. In the right path, the repository accumulates behavior plus at least a reviewable draft of intent, assumptions, and rationale.
