...
This directory will hold canonical English article sources.

## Purpose

Write the approved source version of each article here before localization.

## Structure

- one file per article or article folder
- stable `article_id` metadata
- links to source maps, diagrams, and related material
...
- Public-interest articles
 ...
 - [ISBN Is Not a Database](isbn-not-a-database.md) — Why ISBNs are identifiers, not metadata systems
  ...
  - [Responsibility After Intelligence](responsibility-after-intelligence.md) — Why the deepest AI questions may be less about capability than about judgment, accountability, governance, and dignity
