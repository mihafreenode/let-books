...
summary: Zašto pristupačnost i lokalizaciju treba projektovati zajedno kroz jezičke metapodatke, čitače ekrana, jednostavan jezik, titlove i alt tekst.
topics:
  - accessibility
  - localization
  - multilingual-ux
...
sources:
  - ../../sources/sr-Latn/multilingual-accessibility.md
status: draft
---
...
- [English](../sr-Latn/multilingual-accessibility.md)
