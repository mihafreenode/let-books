...
title: Зошто секој јазик е важен
summary: Зошто третирањето на помалите или регионалните јазици како јазици од прва класа менува кој може да учи, учествува и придонесува.
topics:
  - localization
  - digital-inclusion
  - language-rights
...
sources:
  - ../../sources/mk/why-every-language-matters.md
status: draft
---
...
## Скриената исклученост на системите само на англиски
