...
title: Економика локализације
summary: Како се волонтерски превод, професионална ревизија, AI нацрти и аутоматизација уклапају у реалне буџете локализације.
topics:
  - sustainability
...
sources:
  - ../../sources/sr-Cyrl/economics-of-localization.md
status: draft
---
