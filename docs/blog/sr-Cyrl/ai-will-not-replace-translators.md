...
title: AI неће заменити преводиоце
summary: Зашто AI мења преводилачке токове рада, али не уклања потребу за људском језичком проценом, културним контекстом и прегледом.
topics:
...
sources:
  - ../../sources/sr-Cyrl/ai-will-not-replace-translators.md
status: draft
---
...
- техничке термине треба преводити према доменском значењу; у контекстима тестирања и вредновања `fixture` значи вишекратно употребљив референтни пример или тестни случај, а не физичку инфраструктуру
