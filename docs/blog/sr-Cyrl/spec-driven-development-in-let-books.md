...
У Let Booksу README изричито разликује тренутне испоруке од будућих планова. То сарадницима, институцијама и рецензентима помаже да разумеју зрелост пројекта без нагађања.
...
Ако AI помоћник доприноси Let Booksу, не мора да измишља производ од почетка. Репозиторијум већ садржи ланац намере:
