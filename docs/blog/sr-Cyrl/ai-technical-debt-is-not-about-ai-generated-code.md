...
Мали пример из саме припреме овог чланка то показује врло конкретно. Током прегледа локализације један преведени Markdown фајл задржао је исправно значење, али је случајно увукао једну ставку листе под другу. Непосредна исправка била је једноставна: листу је требало изравнати. Много важније било је сачувати објашњење зашто је то уопште важно. У валидатору је, рецимо, остало записано следеће:

```text
Структура листе део је садржајне исправности, а не само форматирања.

Ако изворни чланак користи равну листу, а локализована верзија случајно угнезди једну ставку, читаоци више не виде исту структуру.

Ова лагана провера штити од честих грешака у увлачењу које смо већ виђали у локализованим чланцима.
```

То објашњење није остало заробљено у коментару током прегледа. Постало је део документације, део валидатора и део будућих прегледа.

Грешка је била једнократна. Разумевање зашто је била важна постало је трајније.
