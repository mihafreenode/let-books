...
Semantic parity is required across localized variants. Literal sentence-by-sentence parity is not.

Published blog coverage is also mandatory across all supported languages. There is no English-only published article policy.
