# Evidencija pregleda AI prevoda

## Sažetak

Ovaj vodič objašnjava kako ljudski recenzenti treba da dokumentuju ispravke prevoda koje je generisao AI kako bi primeri mogli ponovo da se koriste u upravljanju, obuci, QA-u i evaluaciji.

## Zašto je ovo važno

Čak i kada je opšte značenje sačuvano, prevodi koje generiše AI mogu zahtevati pregled izvornog govornika radi ispravke suptilnih problema u gramatici, modalnosti, terminologiji i domenskom registru. Takve probleme je često teško otkriti samo automatizovanim metrikama kvaliteta.

## Obavezni format zapisa pregleda

Svaki pregledani primer treba da zabeleži:
...
## Smernice za hipotezu o uzroku

Beleške recenzenta ne moraju da budu sigurne. Dovoljna je kratka hipoteza ako pomaže budućim recenzentima i radu na evaluaciji modela.
...
## Ponovo upotrebljive lekcije kroz jezike

- Prevod može da sačuva opšte značenje i ipak ne ispuni očekivanja kvaliteta izvornog govornika.
- Modalne konstrukcije su česta slabost AI-ja jer direktna gramatička ekvivalencija između jezika često ne postoji.
- Jezik politika i specifikacija proizvoda često zahteva domenski specifično formulisanje, a ne opšte jezičke sinonime.
- Automatizovane provere mogu da uhvate nedostajuće stringove i pokvarene placeholdere, ali često propuštaju registar, modalnost i suptilno klizanje terminologije.
- Obrazloženje recenzenta treba da bude kratko, ali izričito kako bi primeri mogli da služe za obuku budućih recenzenata i poboljšanje promptova ili evaluacionih skupova.

## Zapis preporuka

Dodajte ovakve primere u ove resurse:
...
- skupove podataka za evaluaciju AI prevoda
...
Primeri pregleda poput ovog mogu da podrže interne scorecarde praćenjem:
