...
Ovaj vodič definiše mali strukturirani format za pohranu pregledanih primjera AI prijevoda kao ponovo upotrebljivih benchmark primjera.

## Svrha

Benchmark primjeri omogućavaju projektu da ponovo koristi stvarne primjere pregleda u:

- obuci recenzenata
- scorecardima kvaliteta
- člancima o lokalizaciji u većem obimu
- dokumentaciji toka rada s čovjekom u petlji
- LLM benchmark evaluacijama

## Preporučena polja primjera

Svaki primjer treba uključiti:
...
- koje se kategorije grešaka najčešće pojavljuju po jeziku
- smanjuju li promptovi ponavljajuće načine neuspjeha
- koliko često pregled izvornog govornika mijenja jezik politika
...
Svaki problem može biti označen i nivoom ozbiljnosti:
...
2. zabilježite kategorije i ozbiljnosti na nivou problema
3. napišite ispravljeni tekst
4. dodijelite preporuku za izdanje
5. po potrebi zabilježite pouzdanost recenzenta

Ovo je namjerno lakše od punog MQM programa. Namijenjeno je praktičnoj ponovljenoj evaluaciji unutar open-source toka rada lokalizacije.
...
Prvi primjer je slovenski primjer AI pregleda modalnosti i terminologije:
