...
`docs/wiki/it/` contiene pagine di riferimento sempreverdi in questa lingua.

## Scopo

Utilizza quest'area per pagine concettuali stabili, spiegazioni con collegamenti brevi e altri contenuti wiki aggiornati nel tempo.
