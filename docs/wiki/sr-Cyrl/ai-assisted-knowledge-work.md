...
summary: >-
  Радни токови вођени спецификацијама важе и изван софтвера: помажу да се AI-потпомогнуто писање, истраживање, документација, рад на политикама и други облици интелектуално захтевног рада обликују кроз експлицитну намеру, валидацију и управљани преглед.
topics:
...
Радни токови вођени спецификацијама не захтевају агенте за кодирање, терминалске алате нити аутоматизацију репозиторијума. Интерактивни AI већ може да помогне у корисном раном раду, као што су израда спецификација, преглед докумената, изоштравање захтева, стварање кандидатског садржаја, препознавање празнина, предлагање стратегија валидације и истраживање алтернатива.
...
- проширење обима: "first I'd focus on interactive web AI"
- практична ограничења: "there's limit how much context AI can hold at once ..."
- архитектура радног тока: "role of skills ... interface to specialised programs"
- забринутости око управљања: "serious security implications of using third party skills"
- забринутости око локализације: "quotes should also be localized to each language"
- консолидација: "one big topic ... prefer few larger articles"
