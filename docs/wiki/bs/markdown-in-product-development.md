...
Markdown je praktičan format za pohranu namjere proizvoda, dokumentacije, vodiča i dokaza u obliku koji je pregledan, prenosiv, uporediv kroz diffove i lako povezan s validacijskim tokovima rada.
...
Markdown dobro funkcioniše kada sadržaj treba biti:
