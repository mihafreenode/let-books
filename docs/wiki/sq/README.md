...
`docs/wiki/sq/` përmban faqe referimi me gjelbërim të përhershëm në këtë gjuhë.

## Qëllimi

Përdoreni këtë zonë për faqe të qëndrueshme konceptesh, shpjegues me lidhje të shkurtra dhe përmbajtje të tjera wiki që përditësohen me kalimin e kohës.

## Faqe të lokalizuara Wiki
