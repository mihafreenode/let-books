...
summary: >-
  Radni tokovi vođeni specifikacijama važe i izvan softvera: pomažu da se AI-potpomognuto pisanje, istraživanje, dokumentacija, rad na politikama i drugi oblici intelektualno zahtevnog rada oblikuju kroz eksplicitnu nameru, validaciju i upravljani pregled.
topics:
...
Radni tokovi vođeni specifikacijama ne zahtevaju agente za kodiranje, terminalske alate niti automatizaciju repozitorijuma. Interaktivni AI već može da pomogne u korisnom ranom radu, kao što su izrada specifikacija, pregled dokumenata, izoštravanje zahteva, stvaranje kandidatskog sadržaja, prepoznavanje praznina, predlaganje strategija validacije i istraživanje alternativa.
...
U praksi mnogi timovi specifikacije, beleške, preglede, nalaze, promptove i artefakte radnog toka čuvaju u Markdownu. Markdown nije jedini koristan format, ali je često praktičan zato što je:
...
Te osobine su važne u AI-potpomognutom radu zato što je kontekst vredan samo ako može da se sačuva, ponovo pregleda i ponovo upotrebi. Markdown olakšava čuvanje više od samog završnog artefakta. Može sačuvati ciljeve, pretpostavke, ograničenja, nalaze pregleda, pravila objavljivanja, rezultate validacije i odluke zajedno sa njihovim obrazloženjem.
...
Zato mnogi agentni radni tokovi koriste ponovno dohvaćanje. Umesto da pokušavaju sve stalno držati u aktivnom vidokrugu, sistem čuva trajne artefakte i po potrebi dohvaća najrelevantniji materijal. Cilj nije nužno dati više informacija odjednom, već dati prave informacije onda kada su potrebne.

Drugo ograničenje su alati. Interaktivne veb platforme obično nude pažljivo odabrane alate dizajnirane da pouzdano rade za široku publiku. Takav kurirani pristup ima stvarne prednosti:
...
Cilj nije jezička čistota. Cilj je da se smanji trenje za čitaoca i da artefakti radnog toka ostanu razumljivi na njegovom radnom jeziku.
...
- proširenje obima: "first I'd focus on interactive web AI"
