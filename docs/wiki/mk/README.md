...
`docs/wiki/mk/` содржи зимзелени референтни страници на овој јазик.

## Цел

Користете ја оваа област за стабилни страници со концепти, кратки поврзани објаснувачи и други вики содржини што се ажурираат со текот на времето.

## Локализирани Вики страници
