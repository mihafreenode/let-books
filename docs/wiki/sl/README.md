...
`docs/wiki/sl/` vsebuje zimzelene referenčne strani v tem jeziku.

## Namen

Uporabite to področje za stabilne konceptualne strani, kratke povezane razlage in drugo wiki vsebino, ki se sčasoma posodablja.

## Lokalizirane Wiki strani
