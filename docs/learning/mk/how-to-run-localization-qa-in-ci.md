...
summary: >-
  Овој водич прикажува како повторливите очекувања од прегледот на локализацијата да се претворат во повторливи CI проверки.
topics:
  - qa
  - ci-cd
...
- расипани врски
- несовпаѓања на placeholder текст
