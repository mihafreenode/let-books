...
summary: >-
  Овај водич објашњава како да спецификацију производа преведете у конкретан имплементациони план, а да при томе не изгубите намеру, границе или правила тока рада која су спецификацију уопште чинила корисном.
topics:
  - spec-writing
...
Многи пројекти не успеју управо у празнини између та два документа.
...
Ако их план изгуби, обично постаје техничка листа обавеза уместо плана испоруке.
...
Имплементациони планови често одступају када се препишу као генерички инжењерски кораци.
