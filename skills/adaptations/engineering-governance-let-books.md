...
- supporting-material HTML logs under `docs/supporting-material/` that preserve extraction reasoning, reconstructed transcript material, planning-phase transcripts, extraction and pilot-validation discussion, and rendering rules for future reuse
