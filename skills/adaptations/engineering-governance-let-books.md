...
- supporting-material HTML logs under `docs/supporting-material/` that preserve extraction reasoning, reconstructed transcript material, planning-phase transcripts, boundary-review discussion, and rendering rules for future reuse
